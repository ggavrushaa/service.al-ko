                ...
                <div class="table layout-fixed">
                    <div class="thead">
                        <div class="tr">
                            ...
                            <div class="th">Група <a href="" class="icon-switch"></a></div>
                            <div class="th">Тривалість <a href="" class="icon-switch"></a></div>
                            <div class="th">Тривалість (хв) <a href="" class="icon-switch"></a></div>
                    ...
                    <div class="tbody">
                        @foreach ($works as $work)
                            <div class="tr">
                                ...
                                <div class="td">{{$work->updated_at}}</div>
                            </div>
                        @endforeach
                    </div>
                </div>
